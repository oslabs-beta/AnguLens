...
export class FolderFileComponent implements OnInit, OnDestroy {
  ...
  uriObj: object = {
    ...
    22H3.9934C3.44476 22 3 21.5447 3 21.0082V2.9918ZM11" fill="white"></path></svg>`,
  };
  options = {
    interaction: {
